...
struct qt_meta_stringdata_WarehouseForm_t {
    QByteArrayData data[3];
    char stringdata0[34];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_WarehouseForm_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_WarehouseForm_t qt_meta_stringdata_WarehouseForm = {
    {
QT_MOC_LITERAL(0, 0, 13), // "WarehouseForm"
QT_MOC_LITERAL(1, 14, 18), // "on_startPB_clicked"
QT_MOC_LITERAL(2, 33, 0) // ""

    },
    "WarehouseForm\0on_startPB_clicked\0"
};
...
void *WarehouseForm::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_WarehouseForm.stringdata0))
        return static_cast<void*>(this);
    return Form::qt_metacast(_clname);
}

int WarehouseForm::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
